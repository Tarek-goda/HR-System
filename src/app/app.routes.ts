...
export const routes: Routes = [
  ...
  {
    path: '',
    loadComponent: () => import('./core/components/main-layout/main-layout').then(m => m.MainLayout),
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          {
            path: 'PersonalInfo',
            loadComponent: () => import('./features/employees/add-employee/personal-info/personal-info').then(m => m.PersonalInfo)
          },
          {
            path: 'JobDetails',
            loadComponent: () => import('./features/employees/add-employee/job-details/job-details').then(m => m.JobDetails)
          },
          {
            path: 'Credentials',
            loadComponent: () => import('./features/employees/add-employee/credentials/credentials').then(m => m.Credentials)
          }
        ]
      }
    ]
